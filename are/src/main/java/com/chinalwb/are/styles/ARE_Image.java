...
//todo: enable this whent he bug does no longer persist
...
//todo: enable this too
	...
	private void openImageChooser() {
		ImageSelectDialog dialog = new ImageSelectDialog(mContext, this, ARE_Toolbar.REQ_IMAGE, ARE_Toolbar.REQ_DRAWING_BITMAP);
		dialog.show();
	}
	...
	public void insertImage(final Object src, final ImageType type) {
        ...
        if (type == ImageType.URI) {
        	//todo: enable this too, bit modified as of date 8/25/2019 12:16 PM
